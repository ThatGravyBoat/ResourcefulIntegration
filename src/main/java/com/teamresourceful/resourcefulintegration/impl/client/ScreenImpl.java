...
public class ScreenImpl extends GuiScreen {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        display.mouseAction(mouseX, mouseY, mouseButton, PeripheralAction.CLICKED);
        clickedX = mouseX;
        clickedY = mouseY;
    }
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state) {
        display.mouseAction(mouseX, mouseY, state, PeripheralAction.RELEASED);
    }
    ...
    public void handleKeyboardInput() throws IOException {
        ...
        if (Keyboard.getEventKey() != Keyboard.KEY_NONE) {
            display.keyAction(Keyboard.getEventKey(), Keyboard.getEventKeyState() ? PeripheralAction.CLICKED : PeripheralAction.RELEASED);
        }
    }
